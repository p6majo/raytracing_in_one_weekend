...
*     <b>2.0.1</b> <br>
*     <tt>
*     Last change:  ALM  17 Mar 2018    8:56 pm
*     </tt>
* <p>
...
**/
public class
Complex implements Cloneable, Serializable,Comparable<Complex> {
  private static final long serialVersionUID = 1L;
    ...
    **/
    ...
    /**
    * Returns the square of the "segment" of a <tt>Complex</tt> number.
    *
    * <p>
    * <pre>
    ...
    * <p>
    * The magnitude is also referred to as the "modulus" or "segment".
    * <p>
    * Always non-negative.
    * <p>
    * @return                  The magnitude (or "segment")
    * <p>
    * @see                     Complex#arg()
    * @see                     Complex#polar(double, double)
    * @see                     Complex#norm()
...
/* */
    ...
    **/
    ...
    public String toString () {
        ...
        String reString = String.format("%.2f",re);
        String imString = String.format("%.2f",im);
        String posImString = String.format("%.2f",Math.abs(im));
    ...
    */
    ...
    /*
    wrapper for old functions of my complex class
     */
    ...
    public static Complex NULL = new Complex(0.,0.);
